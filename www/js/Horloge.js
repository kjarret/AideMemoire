...
if (window.localStorage.getItem("analog") == "true") {
  document.querySelector(".clock").style.display = "block";
  document.querySelector(".horloge").style.flexDirection = "row";
  document.querySelector(".heures").style.display = "none";
  var date = document.querySelector(".date");
  date.style.marginTop = "5%";
  date.style.marginLeft = "26%";
  date.style.width = "300px";
  date.style.textAlignFirst = "center";
} else {
  document.querySelector(".heures").style.visibility = "visible";
  document.querySelector(".date").style.width = "700px";
  document.querySelector(".date").style.textAlign = "left";
}
...
// ca c ton script
const getDisplaySaint = document.getElementById("displaySaint");
const saintDuJour = ephemeris.getTodayEphemeris();
getDisplaySaint.textContent = saintDuJour;
